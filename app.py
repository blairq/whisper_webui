        ...
        try:
            ...
            try:
                ...
                for source in sources:
                    ...
                    filePrefix = slugify(source_prefix + source.get_full_name(), allow_unicode=True)
                    ...
                    if (len(sources) > 1):
                        ...
                        zipFilePrefix = slugify(source_prefix + source.get_full_name(), allow_unicode=True)
